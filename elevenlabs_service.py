...
class ElevenLabsService:
    ...
    def generate_welcome_message(self, user_name=None, language="en", voice_profile="ScienceTeacher", message_type="welcome", location_data=None, events_data=None):
        ...
        message_text = generator(user_name, day_name, date_str, location_data, events_data)
        
        return self.text_to_speech(message_text, voice_id, language, voice_settings)
    
    def _generate_english_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
        name_part = ""
        if user_name:
        ...
        if location_data and location_data.get('success'):
            ...
            if city:
                location_part = f" We can see you're joining us from {city}"
                if region and region != city:
                    location_part += f", {region}"
                if country:
                    location_part += f", {country}"
                location_part += "."
            
            if isp:
                isp_part = f"\n\nI notice you're connecting through {isp}. Even before becoming a full DOT member with an annual membership, you're already gaining insights about your network connectivity just by joining our community. We can help you understand and enhance your connection quality, no matter which provider you use."
        
        # Build events part
        events_part = ""
        if events_data and events_data.get('success') and events_data.get('events'):
            events = events_data.get('events', [])[:3]
            if events:
                events_part = "\n\nSpeaking of what's happening in your area"
                if location_data and location_data.get('success') and location_data.get('city'):
                    events_part += f" around {location_data.get('city')}"
                events_part += ", there have been some exciting events in the last 30 days: "
                ...
                if event_descriptions:
                    events_part += ", ".join(event_descriptions) + "."
        
        return f"""
        {name_part}Welcome to DOT Mobile! Today is {day_name}, {date_str}, and we're thrilled to have you join our global connectivity network.{location_part}
    ...
    def _generate_spanish_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
        name_part = ""
        if user_name:
    ...
    def _generate_french_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
        name_part = ""
        if user_name:
    ...
    def _generate_german_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_italian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_portuguese_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_dutch_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_polish_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_arabic_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_hindi_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_japanese_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_korean_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_chinese_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_russian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_turkish_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_swedish_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_norwegian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_danish_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_finnish_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_czech_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_romanian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_greek_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_hebrew_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_thai_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_vietnamese_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_indonesian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_malay_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_filipino_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_ukrainian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_bulgarian_message(self, user_name, day_name, date_str, location_data=None, events_data=None):
    ...
    def _generate_english_tip(self, user_name, day_name, date_str, location_data=None, events_data=None):
        return f"""
    ...
    def _generate_spanish_tip(self, user_name, day_name, date_str, location_data=None, events_data=None):
        return f"""
    ...
    def _generate_french_tip(self, user_name, day_name, date_str, location_data=None, events_data=None):
        return f"""
    ...
    def _generate_english_update(self, user_name, day_name, date_str, location_data=None, events_data=None):
        return f"""
    ...
    def _generate_spanish_update(self, user_name, day_name, date_str, location_data=None, events_data=None):
        return f"""
    ...
    def _generate_french_update(self, user_name, day_name, date_str, location_data=None, events_data=None):
        return f"""
