...
def export_api_docs():
    """Export API documentation as static files with GitHub integration"""
    try:
        import os
        import json
        ...
        # Create comprehensive README with GitHub integration
        readme_content = f"""# 🌐 GORSE Platform API Documentation

{spec.get('info', {}).get('description', 'Global Connectivity Service and Network API Access')}
...
## 📅 Version
API Version: {spec.get('info', {}).get('version', '3.0')}
...
"""
        ...
        # Create enhanced HTML page with GitHub integration
        html_content = f"""<!DOCTYPE html>
<html>
<head>
    <title>{spec.get('info', {}).get('title', 'GORSE Platform API')}</title>
...
<body>
    <div class="github-banner">
        📚 <a href="https://github.com/dataontap/gorse" target="_blank">View on GitHub</a> | 
        🌐 <a href="/docs">Platform Documentation</a> | 
        🔧 <a href="/db-test">System Status</a>
    </div>
    <div class="platform-info">
        <h2>🌐 GORSE Platform API</h2>
        <p>Global Connectivity Service and Network API Access</p>
        <p><strong>Live API:</strong> <a href="/api">/api</a> | <strong>Version:</strong> {spec.get('info', {}).get('version', '3.0')}</p>
    </div>
    ...
    <script>
        ...
        return jsonify({
            'status': 'success',
            'message': f'Enhanced API documentation exported to {docs_dir}/',
            'files': ['index.html', 'openapi.json', 'README.md'],
            'github_integration': 'https://github.com/dataontap/gorse',
            'live_docs': '/docs',
            'api_endpoint': '/api'
        })
